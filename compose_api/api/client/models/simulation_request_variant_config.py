...
if TYPE_CHECKING:
    from ..models.simulation_request_variant_config_additional_property import (
...
class SimulationRequestVariantConfig:
    ...
    additional_properties: dict[str, "SimulationRequestVariantConfigAdditionalProperty"] = _attrs_field(
